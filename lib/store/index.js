...
var PersistStore = /** @class */ (function (_super) {
    ...
    function PersistStore(name, options) {
        ...
        var newState = Object.assign(Object.create(null), localState, state || {});
...
export var globalStoreOptions = {
    ...
    mutations: {
        ...
        // 保存定位信息
        updateLocationInfo: function (state, locationInfo) {
            state.locationInfo = locationInfo;
        },
        // 保存城市信息
        updateCityInfo: function (state, cityInfo) {
            state.cityInfo = cityInfo;
        },
        // 保存定位城市信息
        updateLocCityInfo: function (state, locCityInfo) {
